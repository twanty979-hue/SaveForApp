...
class _RecurringExpenseScreenState extends State<RecurringExpenseScreen> {
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  activeStep == 0
                                      ? 'ขั้นตอน 1 จาก 2 : เลือกประเภทรายจ่าย'
                                      : 'ขั้นตอน 2 จาก 2 : กำหนดยอดเงินและวันครบกำหนด',
                    ...
                    if (activeStep == 0) ...[
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: context.tr('เช่น ค่าเน็ต, ค่าห้อง', 'e.g. internet bill, rent'),
                          ...
                          Expanded(
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                icon: Icon(
                                  expenseToEdit != null ? Icons.check_rounded : Icons.add_rounded,
                                  size: 18,
                                  color: Colors.white,
                                ),
                                label: Text(
  ...
  Widget _buildExpenseListCard({
    ...
    return SplitListCard(
      ...
      accentColor: accent,
      leadingColor: const Color(0xFFFFF1F2),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                hasPaid
                    ? 'ชำระแล้ว ฿${formatMoney(paidAmount)}'
