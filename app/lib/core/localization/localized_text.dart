...
const Map<String, String> _thaiToEnglish = {
  ...
  'เข้าสู่ระบบเพื่อเริ่มใช้งาน': 'Sign in to get started',
  'สมัครสมาชิกเพื่อเริ่มใช้งาน': 'Create an account to get started',
  ...
  'ไม่สามารถโหลดข้อมูลโปรไฟล์ได้': 'Unable to load profile.',
  'เกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้ง': 'An error occurred. Please try again.',
  'ไม่สามารถเชื่อมต่อได้ กรุณาลองใหม่อีกครั้ง': 'Unable to connect. Please try again.',
  'รหัสผ่าน': 'Password',
  'อีเมล': 'Email',
